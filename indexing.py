...
if __name__ == "__main__":
    ...
    loader = TextLoader("/content/text document.txt")
    ...
    vector_db = PineconeVectorStore.from_documents(split_documents, embeddings, index_name=os.getenv("PINECONE_INDEX_NAME"), )
